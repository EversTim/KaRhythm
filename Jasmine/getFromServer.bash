...
bodyCloseTagLineNumber=`grep -n -m 1 script $scratch/testFile.html | cut -f 1 -d ":"`
lineAfterBodyTagNumber=$((bodyTagLineNumber+1))
lineBeforeCloseTagNumber=$((bodyCloseTagLineNumber-1))

echo "<div style=\"display: none;\">" > $scratch/testFileBody.html

sed -n ""$lineAfterBodyTagNumber","$lineBeforeCloseTagNumber"p" $scratch/testFile.html >> $scratch/testFileBody.html
